...
IF EOF()
   ...
   SET COLOR TO *R+/B
   @14,26 SAY 'NO EXISTEN DATOS DE RUBROS'
   SET COLOR TO W+/B
   INKEY(3)
   ...
   RESTORE SCREEN FROM ANDRES
   APPEND BLANK
   REPLACE NOMBRES WITH VRUBR,CODIGO WITH 1
   GO TOP
ENDIF
SET COLOR TO W+/B
@6,20 TO 15,59
...
@24,1 SAY 'Buscar:                                                                       '
SET COLOR TO BG/B,B/W
DBEDIT(7,21,14,58,CAMP,'FUNCAJA2','',CABEZ,SEPAR)
IF LASTKEY()=27
   RETURN
ENDIF
STORE NOMBRES TO VRUBR
RESTORE SCREEN FROM TOMARUBR
IF PULSO=1
   SET COLOR TO BG/B
   @7,1 SAY 'Firma:                                     Rubro:'
   SET COLOR TO W+/B
